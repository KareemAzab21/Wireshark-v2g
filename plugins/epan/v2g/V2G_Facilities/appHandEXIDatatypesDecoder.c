...
static int V2gFac_decode_appHandAppProtocolType(bitstream_t* stream,  appHandAppProtocolType* appHandAppProtocolType);
static int V2gFac_decode_appHandAnonType_supportedAppProtocolReq(bitstream_t* stream,  appHandAnonType_supportedAppProtocolReq* appHandAnonType_supportedAppProtocolReq);
static int V2gFac_decode_appHandAnonType_supportedAppProtocolRes(bitstream_t* stream,  appHandAnonType_supportedAppProtocolRes* appHandAnonType_supportedAppProtocolRes);
...
static int V2gFac_decode_appHandAppProtocolType(bitstream_t* stream,  appHandAppProtocolType* appHandAppProtocolType) {
	...
	V2gFac_init_appHandAppProtocolType(appHandAppProtocolType);
...
static int V2gFac_decode_appHandAnonType_supportedAppProtocolReq(bitstream_t* stream,  appHandAnonType_supportedAppProtocolReq* appHandAnonType_supportedAppProtocolReq) {
	...
	V2gFac_init_appHandAnonType_supportedAppProtocolReq(appHandAnonType_supportedAppProtocolReq);
			...
			if (errn == 0) {
				...
				case 0:
					if (appHandAnonType_supportedAppProtocolReq->AppProtocol.arrayLen < appHandAnonType_supportedAppProtocolReq_AppProtocol_ARRAY_SIZE) {
						errn = V2gFac_decode_appHandAppProtocolType(stream, &appHandAnonType_supportedAppProtocolReq->AppProtocol.array[appHandAnonType_supportedAppProtocolReq->AppProtocol.arrayLen++]);
					} else { 
...
static int V2gFac_decode_appHandAnonType_supportedAppProtocolRes(bitstream_t* stream,  appHandAnonType_supportedAppProtocolRes* appHandAnonType_supportedAppProtocolRes) {
	...
	V2gFac_init_appHandAnonType_supportedAppProtocolRes(appHandAnonType_supportedAppProtocolRes);
...
int V2gFac_decode_appHandExiDocument(bitstream_t* stream,  appHandEXIDocument* exiDoc) {
	...
	/* check if there is errors in reading header step */
	if(errn == 0) {
		...
		/* initialize the exiDoc ure */
		V2gFac_init_appHandEXIDocument(exiDoc);

		/* decode 2 bits to know the handshake type */
		errn = decodeNBitUnsignedInteger(stream, 2, &eventCode);

		/* check if there is no errors in past decoding step */
		if(errn == 0) {

			/* switch case on decoded data */
			switch(eventCode) {
			...
			case 0:
				...
				/* call decoding function for handshake request */
				errn = V2gFac_decode_appHandAnonType_supportedAppProtocolReq(stream, &exiDoc->supportedAppProtocolReq);
			...
			case 1:
				...
				/* call decoding function for handshake response */
				errn = V2gFac_decode_appHandAnonType_supportedAppProtocolRes(stream, &exiDoc->supportedAppProtocolRes);

				/* assign 1 to response is used */
